...
export const learningTracks = [
  {
    id: 'new', label: 'New to Insurance', desc: 'Start from scratch — understand the basics of life insurance and why it matters for your family.',
    icon: '🌱', color: '#2C5F2D', progress: 33,
    modules: [
      { id: 'mod-1', title: 'What is Life Insurance?', desc: 'Understand the concept, types, and why every family needs it.', videoIds: ['v1'], duration: '3:24', completed: true },
      { id: 'mod-2', title: 'How Claims Work', desc: 'The claim process demystified — documents, timelines, and your rights.', videoIds: ['v3'], duration: '3:55', completed: false },
      { id: 'mod-3', title: 'Myths Busted', desc: 'Do companies actually pay claims? Is term insurance a waste? Get real answers.', videoIds: ['m1'], duration: '2:45', completed: false },
    ]
  },
  {
    id: 'moderate', label: 'Growing Your Cover', desc: 'You have a policy — now learn how to optimise your protection and make smarter choices.',
    icon: '📊', color: '#003B71', progress: 0,
    modules: [
      { id: 'mod-4', title: 'Term vs ULIP', desc: 'Understand the real difference and when each makes sense for your goals.', videoIds: ['v2'], duration: '4:10', completed: false },
      { id: 'mod-5', title: 'How Much Cover Do You Need?', desc: 'Calculate the right coverage for your family based on income, loans, and goals.', videoIds: ['v4'], duration: '4:22', completed: false },
      { id: 'mod-6', title: 'Critical Illness Cover', desc: 'Cancer, heart attack, stroke — understand what critical illness riders cover.', videoIds: ['v7'], duration: '4:05', completed: false },
    ]
  },
  {
    id: 'advanced', label: 'Advanced Planning', desc: 'Maximise your portfolio — tax benefits, fund performance, and rider optimisation.',
    icon: '🎯', color: '#8B1A1A', progress: 0,
    modules: [
      { id: 'mod-7', title: 'Tax Benefits on Insurance', desc: 'How 80C & 10(10D) work — maximise your tax savings with the right structure.', videoIds: ['v8'], duration: '3:30', completed: false },
      { id: 'mod-8', title: 'ULIP Fund Performance', desc: 'Track, switch, and optimise your market-linked returns.', videoIds: ['v5'], duration: '2:58', completed: false },
      { id: 'mod-9', title: 'Pre-existing Conditions', desc: 'Waiting periods, disclosure rules, and your rights as a policyholder.', videoIds: ['v6'], duration: '3:55', completed: false },
    ]
  },
]
